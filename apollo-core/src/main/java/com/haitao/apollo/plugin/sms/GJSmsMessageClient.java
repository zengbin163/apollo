...
public class GJSmsMessageClient {
	...
	public GJSmsMessageClient(String sn, String password){
		this.sn = sn;
	...
	public String sendSMS(String mobile, String content, String ext, String stime, String rrid) {
		String result = "";
